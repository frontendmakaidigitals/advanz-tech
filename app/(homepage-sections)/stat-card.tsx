...
export default function StatCard() {
  return (
    <div className="grid grid-cols-1 border-t border-b border-slate-400 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-20 ">
  ...
  return (
    <motion.div ref={ref} className=" backdrop-blur-sm p-6 text-center">
      <div className="flex justify-center items-baseline ">
        <NumberFlow
          value={value}
          className="text-6xl  text-black font-inter! tracking-tighter font-medium"
